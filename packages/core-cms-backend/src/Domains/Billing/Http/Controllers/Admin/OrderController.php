...
namespace TuranFurkan\CoreCms\Domains\Billing\Http\Controllers\Admin;

use TuranFurkan\CoreCms\Domains\Billing\Http\Resources\OrderResource;
    ...
    public function index(Request $request): AnonymousResourceCollection
    {
        $query = Order::query()->with([
            ...
            'items.orderable' => function ($morphTo) {
                $morphTo->morphWith([
                    \TuranFurkan\CoreCms\Domains\Race\Models\Registration::class => ['participant', 'race'],
                ]);
            },
            'transactions',
        ]);
