...
namespace TuranFurkan\CoreCms\Domains\Category\Http\Resources;

use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

/**
 * @mixin \TuranFurkan\CoreCms\Domains\Category\Models\Category
 */
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'cover_image' => $this->relationLoaded('coverImage') && $this->coverImage
                ? (new \TuranFurkan\CoreCms\Domains\Media\Http\Resources\MediaResource($this->coverImage))->toArray($request)
                : null,
            ...
            'races' => \TuranFurkan\CoreCms\Domains\Race\Http\Resources\RaceResource::collection($this->whenLoaded('races')),
