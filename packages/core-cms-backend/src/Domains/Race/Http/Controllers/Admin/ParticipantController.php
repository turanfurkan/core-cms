...
use TuranFurkan\CoreCms\Domains\Race\Http\Requests\ParticipantRequest;
...
use TuranFurkan\CoreCms\Domains\Race\Actions\CreateParticipantAction;
use TuranFurkan\CoreCms\Domains\Race\Actions\UpdateParticipantAction;
use TuranFurkan\CoreCms\Domains\Race\Actions\DeleteParticipantAction;
...
class ParticipantController extends Controller
{
    ...
    public function store(ParticipantRequest $request, CreateParticipantAction $action): JsonResponse
    {
        ...
        if ($request->filled('race_id')) {
            \TuranFurkan\CoreCms\Domains\Race\Models\Registration::create([
