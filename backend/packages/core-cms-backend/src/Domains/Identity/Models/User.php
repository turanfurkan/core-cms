...
class User extends Authenticatable implements MustVerifyEmail, HasMedia
{
    ...
    {
        return $this->hasMany(\TuranFurkan\CoreCms\Domains\Race\Models\Participant::class);
    }

    public function registrations(): HasMany
    {
        return $this->hasMany(\TuranFurkan\CoreCms\Domains\Race\Models\Registration::class, 'user_id');
    }
