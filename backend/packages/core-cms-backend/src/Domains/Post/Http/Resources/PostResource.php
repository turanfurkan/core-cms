...
namespace TuranFurkan\CoreCms\Domains\Post\Http\Resources;

use Illuminate\Http\Request;
use Illuminate\Http\Resources\Json\JsonResource;

/**
 * @mixin \TuranFurkan\CoreCms\Domains\Post\Models\Post
 */
class PostResource extends JsonResource
{
    ...
    protected function hydrateBlocks(array $blocks): array
    {
        ...
        if (!empty($categoryIds)) {
            $categories = \TuranFurkan\CoreCms\Domains\Category\Models\Category::whereIn('id', array_unique($categoryIds))
                ->get()
                ->keyBy('id');
        }
