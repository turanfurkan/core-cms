...
namespace App\Domains\Identity\Http\Controllers\Profile;

use App\Domains\Identity\Actions\Profile\DeleteAccountAction;
use App\Domains\Identity\Actions\Profile\StoreUserConsentAction;
use App\Domains\Identity\Actions\Profile\UpdateAvatarAction;
use App\Domains\Identity\Actions\Profile\UpdatePasswordAction;
use App\Domains\Identity\Actions\Profile\UpdateProfileAction;
use App\Domains\Identity\Actions\Profile\UploadUserDocumentAction;
use App\Domains\Identity\DTOs\UpdateProfileData;
use App\Domains\Identity\Http\Requests\Profile\DeleteAccountRequest;
use App\Domains\Identity\Http\Requests\Profile\StoreConsentRequest;
use App\Domains\Identity\Http\Requests\Profile\UpdateAvatarRequest;
use App\Domains\Identity\Http\Requests\Profile\UpdatePasswordRequest;
use App\Domains\Identity\Http\Requests\Profile\UpdateProfileRequest;
use App\Domains\Identity\Http\Requests\Profile\UploadDocumentRequest;
