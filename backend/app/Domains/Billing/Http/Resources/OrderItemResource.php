...
/**
 * @mixin \App\Domains\Billing\Models\OrderItem
 */
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'orderable' => $this->relationLoaded('orderable') && $this->orderable
                ? ($this->orderable instanceof \App\Domains\Race\Models\Registration
                    ? new \App\Domains\Race\Http\Resources\RegistrationResource($this->orderable)
                    : $this->orderable)
                : null,
