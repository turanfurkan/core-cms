...
class Race extends Model
{
    ...
    {
        return $this->belongsTo(\App\Domains\Media\Models\MediaItem::class, 'cover_image_id');
    }

    public function graphicImage(): BelongsTo
    {
        return $this->belongsTo(\App\Domains\Media\Models\MediaItem::class, 'graphic_image_id');
    }

    public function gpxFile(): BelongsTo
    {
        return $this->belongsTo(\App\Domains\Media\Models\MediaItem::class, 'gpx_file_id');
    }

    public function stravaFile(): BelongsTo
    {
        return $this->belongsTo(\App\Domains\Media\Models\MediaItem::class, 'strava_file_id');
    }
