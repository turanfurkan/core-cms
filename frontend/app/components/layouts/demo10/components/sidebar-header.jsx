  ...
  return (
    <div className="flex flex-col gap-2.5">
      <div className="flex items-center justify-between gap-2.5 px-3.5 h-[70px]">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="cursor-pointer text-foreground font-medium flex items-center justify-between gap-2 w-[190px]">
            Metronic
      ...
      <div className="flex items-center gap-2.5 px-3.5">
        <Button
          asChild
          variant="secondary"
          className="justify-center w-full max-w-[198px]"
        >
